...
const CompactPersonalLoanCalculator: React.FC = () => {
    ...
    <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100">
      ...
      <div className="space-y-4 text-sm">
        <div>
          ...
          <input type="range" min="1000" max="50000" step="500" value={loanAmount} onChange={e => setLoanAmount(Number(e.target.value))} className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-brand-purple" />
        </div>
        <div>
          ...
          <input type="range" min="3" max="36" step="0.25" value={interestRate} onChange={e => setInterestRate(Number(e.target.value))} className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-brand-purple" />
        </div>
        <div>
          ...
          <input type="range" min="2" max="7" step="1" value={loanTerm} onChange={e => setLoanTerm(Number(e.target.value))} className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-brand-purple" />
        </div>
      </div>
...
export default CompactPersonalLoanCalculator;